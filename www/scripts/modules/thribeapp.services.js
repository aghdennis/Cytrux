...
define(["require", "exports", "core", "ionic-native-geolocation", "../services/ThribeAppMocks"], function (require, exports, core_1, ionic_native_geolocation_1, ThribeAppMocks_1) {
    "use strict";
    ...
    var ThribeAppServicesModule = (function () {
        ...
        ThribeAppServicesModule = __decorate([
            core_1.NgModule({
                //exports: [ Geolocation, GeolocationMock ],
                providers: [
