 ...
 * License: MIT
 */
define(['exports', 'core', 'observable/forkJoin', 'observable/fromPromise', 'operator/map', 'platform-browser'],
    function (exports, _angular_core, rxjs_observable_forkJoin, rxjs_observable_fromPromise, rxjs_operator_map, _angular_platformBrowser)
    {
        'use strict';
