 ...
 * License: MIT
 */
define(['exports', 'common', 'core',
    'rxjs/BehaviorSubject', 'rxjs/Subject', 'observable/from',
    'observable/of', 'operator/concatMap', 'operator/every',
    'operator/first', 'operator/last', 'operator/map',
    'operator/mergeMap', 'operator/reduce', 'rxjs/Observable',
    'operator/catch', 'operator/concatAll', 'util/EmptyError',
    'observable/fromPromise', 'operator/mergeAll',
    'platform-browser', 'operator/filter'], 
    function (exports, _angular_common, _angular_core, rxjs_BehaviorSubject, rxjs_Subject,
        rxjs_observable_from, rxjs_observable_of, rxjs_operator_concatMap,
        rxjs_operator_every, rxjs_operator_first, rxjs_operator_last,
        rxjs_operator_map, rxjs_operator_mergeMap, rxjs_operator_reduce,
        rxjs_Observable, rxjs_operator_catch, rxjs_operator_concatAll,
        rxjs_util_EmptyError, rxjs_observable_fromPromise,
        rxjs_operator_mergeAll, _angular_platformBrowser, rxjs_operator_filter) {
            'use strict';
